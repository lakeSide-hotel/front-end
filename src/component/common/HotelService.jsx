        ...
        <Row>
          <h4 className="text-center mt-3">
            ...
            <span className="gap-2">
              <FaClock style={{ marginBottom: '2px' }} /> - 24-Hour Front Desk
            </span>
          </h4>
        </Row>
        <hr />
          ...
          <Col>
            <Card>
              <Card.Body style={{ minHeight: '120px' }}>
                ...
                <Card.Text>
                  Enjoy a refeshing drink or snack from our in-room mini-bar.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col>
            <Card>
              <Card.Body style={{ minHeight: '120px' }}>
                ...
                <Card.Text>
                  Park your car conveniently in our room on-site parking lot.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
